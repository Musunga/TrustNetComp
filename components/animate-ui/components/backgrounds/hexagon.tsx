              ...
              (_, colIndex) => (
                <div
                  ...
                  className={cn(
                    ...
                    'hover:before:bg-primary/20 dark:hover:before:bg-primary/20 hover:before:opacity-100 hover:before:duration-0 hover:after:bg-primary dark:hover:after:bg-primary hover:after:opacity-100 hover:after:duration-0',
